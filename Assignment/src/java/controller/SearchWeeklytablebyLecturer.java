 ...
 * @author Admin
 */
public class SearchWeeklytablebyLecturer extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SearchWeeklytablebyLecturer</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SearchWeeklytablebyLecturer at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        request.setAttribute("lecturerSelected",lecturerID);
        ...
        ArrayList<Session> sessList = db3.getSessionListOneWeek(lecturerID);
